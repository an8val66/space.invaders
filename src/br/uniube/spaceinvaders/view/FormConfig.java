...
public class FormConfig extends JFrame
{
    ...
    {    
        ...
        JSlider sliderVelocidadeShooter;
        ...
        private void salvar()
        {
            ...
            Configs.sliderVelocidadeShooter = sliderVelocidadeShooter.getValue();
        }
        
        public void carregarConfigs()
        {
            chkMovimentoPersistente.setSelected(Configs.isMovimentoPersistente);
            sliderVelocidadeShooter.setValue(Configs.sliderVelocidadeShooter);
        }   
    }
}
